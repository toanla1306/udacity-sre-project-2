...
2. Copy the AMI to your account
   ...
   **Restore image**
    ...
    ```shell
    aws ec2 create-restore-image-task --object-key ami-0ec6fdfb365e5fc00.bin --bucket udacity-srend --name "udacity-project-2-sre-toanla"
    ```
    ...
    - Take note of that AMI ID the script just output. Copy the AMI to `us-east-2` and `us-west-1`:
        - `aws ec2 copy-image --source-image-id ami-04057a87ebfc0c47e --source-region us-east-1 --region us-east-2 --name "udacity-project-2-sre-toanla"`
        - `aws ec2 copy-image --source-image-id ami-04057a87ebfc0c47e --source-region us-east-1 --region us-west-1 --name "udacity-project-2-sre-toanla"`
    ...
    `aws s3api create-bucket --bucket project-2-sre-course-toanld7 --region us-east-2 --create-bucket-configuration LocationConstraint=us-east-2`
